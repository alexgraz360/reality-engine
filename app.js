...
const ACTION_TYPES = { add_note: 1, list_notes: 1, delete_note: 1, add_reminder: 1, list_reminders: 1, delete_reminder: 1 };
...
document.getElementById("ccConfirmYes").addEventListener("click", () => {
  ...
  try {
    ...
    else { localActions.deleteReminder(a.target.id); line = `✓ Deleted reminder: “${a.target.text}”.`; }
  } catch (err) {
    line = "Couldn't do that: " + err.message;
  }
  transcriptNote(line);
  renderNotesSheet();
